...
namespace serviceSphere.Controllers
{
    public class bookingController : Controller
    {
        ...
        public ActionResult BookService(int service_id, int provider_id)
        {
            ...
            var service = dbobj.servicetabs.FirstOrDefault(x => x.service_id == service_id);
        ...
        public ActionResult BookService(booking obj)
        {
            ...
            dbobj.sp_book_service(user_id, obj.service_id, obj.provider_id, obj.service_date, obj.service_time, obj.address, obj.description);
