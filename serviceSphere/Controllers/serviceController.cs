    ...
    public class serviceController : Controller
    {
        ...
        public ActionResult service_click(service clsobj)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                dbobj.sp_insert_service(pid, clsobj.category_id, clsobj.service_name, clsobj.service_description, clsobj.service_price, img,
                                         "Available", clsobj.location);
        ...
        public ActionResult edit_service_click(service clsobj)
        {
            if (ModelState.IsValid)
            {
                dbobj.sp_update_service(clsobj.service_id, clsobj.category_id, clsobj.service_name, clsobj.service_description,
                                       clsobj.service_price, clsobj.service_image, clsobj.service_status, clsobj.location);
                return RedirectToAction("viewservice");            
            }
            return View(clsobj);
        }
