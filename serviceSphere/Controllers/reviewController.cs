...
namespace serviceSphere.Controllers
{
    public class reviewController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddReview(int booking_id, int service_id, int rating, string review_message)                                
        {
            int user_id = Convert.ToInt32(Session["uid"]);
            dbobj.sp_add_review(booking_id, user_id, service_id, rating, review_message);
